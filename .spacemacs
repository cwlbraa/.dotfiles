...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     (ruby :variables ruby-version-manager 'chruby ruby-backend 'lsp)
     ruby-on-rails
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (setq exec-path (append exec-path '("/home/braa/go/bin")))
  (setenv "GOPATH" "/home/braa/go")
  (when (configuration-layer/layer-usedp 'github)
    (with-eval-after-load 'forge-core
      (add-to-list 'forge-alist
                   '("gitlab.eng.vmware.com" "gitlab.eng.vmware.com/api/v4" "gitlab.eng.vmware.com" forge-gitlab-repository))))
...
before packages are loaded."
  ...
  (defun dotfiles--lsp-flycheck-enable-shellcheck ()
    "Enable Shellcheck for shell buffers under LSP. Unnecessary if https://github.com/bash-lsp/bash-language-server/issues/104 is resolved"
